...
public class BlockAppleLeaves extends Block {
    ...
    /**
     * Apple leaves that use copy-pasted code from BlockLeaves.
     * Can be sheared. Drops apples occasionally otherwise.
     *
     * @param id Block ID to use.
     * @see BlockLeaves
     */
    public BlockAppleLeaves(int id) {
        super(id, ModLoader.addOverride("/terrain.png", "/glassedibles/appleleaves.png"), Material.leaves);
        setStepSound(Block.leaves.stepSound);
        setTickOnLoad(true);
        setBlockName("blockAppleLeaves");
